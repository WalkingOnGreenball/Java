...
public class Exam_SetCollection {
	...
	public static void main(String[] args) {
		// Collection 의 List, Set, Map -> 저장소의 역할
		...
		printSize(stdSet);
		stdSet.add(new Student("강동원", 35, 100)); // 위의 강동원과 같은지 아닌지 컴퓨터는 모른다, 그러므로 오버라이딩 해야 겹치기 가능
		printSize(stdSet);
	...
	public void strSetExample() {
		...
		// stdList.get(0) -> 값 출력 (ArrayList 는 순서를 가지고 출력)
