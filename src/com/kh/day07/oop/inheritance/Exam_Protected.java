...
class ShapePoint extends Point {
	...
	void set() {
		super.pub = 1;
//		super.def = 2; // 다른 패키지의 것은 가져올 수 없다. The field Point.def is not visible
		super.pro = 3; // 다른 패키지에 있어도 상속관계에 있으면 접근 가능
//		super.pri = 4; // 당연히 안된다. The field Parent.pri is not visible
	}
}
